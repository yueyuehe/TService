...
{
   /// <summary>
   /// 实体对象 tbl_Requirement(需求项目)。
   /// </summary>
   [Serializable()]
   [Table("tbl_Requirement","需求项目")]
   partial class tbl_Requirement: DataEntity<tbl_Requirement>, IDataEntity<tbl_Requirement>
   {
       public tbl_Requirement()
       {
       }
       
       protected tbl_Requirement(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// GUID 。
       /// </summary>
       [Column("GUID","GUID"),DataSize(50),PrimaryKey,NotNull]
       [DisplayName("GUID")]
       public string GUID
       {
           get;
       ...
       /// 提出者ID 。
       /// </summary>
       [Column("UserId","提出者ID"),DataSize(50)]
       [DisplayName("提出者ID")]
       ...
       /// 工时 。
       /// </summary>
       [Column("ManHour","工时"),DataSize(18,2)]
       [DisplayName("工时")]
       ...
       private tbl_User m_User;

       /// <summary>
       /// 创建者 。
       /// </summary>
       [RefEntity("UserId", "创建者", typeof(tbl_User), "GUID", true, false)]
       public tbl_User User
       {
           get
           {
               if ((this.m_User == null && !string.IsNullOrEmpty(this.UserId)) || (this.m_User!=null && this.m_User.GUID != this.UserId))
               {
                   this.m_User = DataEntity<tbl_User>.Lazy(this.UserId);
               }
