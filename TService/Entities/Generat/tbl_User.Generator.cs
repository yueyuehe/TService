...
namespace TService.Entities
{
   ...
   [Serializable()]
   [Table("tbl_User","用户表")]
   partial class tbl_User: DataEntity<tbl_User>, IDataEntity<tbl_User>
   {
       public tbl_User()
       {
       }
       
       protected tbl_User(SerializationInfo info, StreamingContext context): base(info, context)
       {
       }
       ...
       /// 密码 。
       /// </summary>
       [Column("Password","密码"),DataSize(128)]
       [DisplayName("密码")]
